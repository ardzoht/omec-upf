...
func (t *P4rtTranslator) BuildInterfaceTableEntryNoAction() *p4.TableEntry {
	entry := &p4.TableEntry{
		TableId:  TablePreQosPipeInterfaces,
...
func (t *P4rtTranslator) BuildInterfaceTableEntry(ipNet *net.IPNet, sliceID uint8, isCore bool) (*p4.TableEntry, error) {
	...
	action := &p4.Action{
		ActionId: ActionPreQosPipeSetSourceIface,
	}
...
func (t *P4rtTranslator) BuildApplicationsTableEntry(pdr pdr, sliceID uint8, internalAppID uint8) (*p4.TableEntry, error) {
	...
	entry := &p4.TableEntry{
		TableId: TablePreQosPipeApplications,
	...
	action := &p4.Action{
		ActionId: ActionPreQosPipeSetAppId,
	}
...
func (t *P4rtTranslator) buildUplinkSessionsEntry(pdr pdr, sessMeterIdx uint32) (*p4.TableEntry, error) {
	...
	entry := &p4.TableEntry{
		TableId:  TablePreQosPipeSessionsUplink,
		Priority: DefaultPriority,
	}
	...
	action := &p4.Action{
		ActionId: ActionPreQosPipeSetSessionUplink,
	}
...
func (t *P4rtTranslator) buildDownlinkSessionsEntry(pdr pdr, sessMeterIdx uint32, tunnelPeerID uint8, needsBuffering bool) (*p4.TableEntry, error) {
	...
	entry := &p4.TableEntry{
		TableId:  TablePreQosPipeSessionsDownlink,
		Priority: DefaultPriority,
	}
	...
	if needsBuffering {
		action = &p4.Action{
			ActionId: ActionPreQosPipeSetSessionDownlinkBuff,
		}
	} else {
		action = &p4.Action{
			ActionId: ActionPreQosPipeSetSessionDownlink,
		}
...
func (t *P4rtTranslator) buildUplinkTerminationsEntry(pdr pdr, appMeterIdx uint32, shouldDrop bool, internalAppID uint8, tc uint8, relatedQER qer) (*p4.TableEntry, error) {
	...
	entry := &p4.TableEntry{
		TableId:  TablePreQosPipeTerminationsUplink,
		Priority: DefaultPriority,
	}
	...
	if shouldDrop {
		action = &p4.Action{
			ActionId: ActionPreQosPipeUplinkTermDrop,
		}
	} else {
		action = &p4.Action{
			ActionId: ActionPreQosPipeUplinkTermFwd,
		}
...
func (t *P4rtTranslator) buildDownlinkTerminationsEntry(pdr pdr, appMeterIdx uint32, relatedFAR far,
	...
	entry := &p4.TableEntry{
		TableId:  TablePreQosPipeTerminationsDownlink,
		Priority: DefaultPriority,
	}
	...
	if shouldDrop {
		action = &p4.Action{
			ActionId: ActionPreQosPipeDownlinkTermDrop,
		}
	} else {
		action = &p4.Action{
			ActionId: ActionPreQosPipeDownlinkTermFwd,
		}
...
func (t *P4rtTranslator) BuildGTPTunnelPeerTableEntry(tunnelPeerID uint8, tunnelParams tunnelParams) (*p4.TableEntry, error) {
	...
	entry := &p4.TableEntry{
		TableId:  TablePreQosPipeTunnelPeers,
		Priority: DefaultPriority,
		Action: &p4.TableAction{
			Type: &p4.TableAction_Action{
				Action: &p4.Action{
					ActionId: ActionPreQosPipeLoadTunnelParam,
				},
			},
		},
	}
